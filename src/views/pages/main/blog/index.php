...
<main>
  <form class="search">
    <div><input type="search" name="search" id="search" placeholder="Pesquisar"><button>Pesquisar</button></div>
  </form>
  <div class="slog">
    ...
    <a href="articles/autocompaixao.php" class="destach">
      ...
      <div class="hastag">
        <span class="hastag-item">Autocompaixão</span>
        <span class="hastag-item">Auto estima</span>
        <span class="hastag-item">Transformação</span>
      </div>
    </a>
    <section>
      <a class="article">
